...
%% GUI
        ...
        uicontrol(p1_5,'units','characters','Position',[13.6 2.769 27.6 1.692],...
                    ...
                    'String','GLDAS/CLM|GLDAS/MOS|GLDAS/NOAH (0.25)|GLDAS/NOAH (1.00)|GLDAS/VIC|ERA Interim|MERRA (assimilation)|Other|GRACE|NCEP Reanalysis-2|MERRA2|NCEP Reanalysis-1',...
...
%% Button response
        ...
        switch in_switch                                                    % switch between callbacks  
            ...
            case 'calc_down_gldas'
                [name,path] = uigetfile('*.nc','Choose your input GLDAS or MERRA netCDF file'); % select ERA interim netcdf (*.nc) input file
                if name == 0                                                
