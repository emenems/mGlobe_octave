...
%   file_type      ...  switch (1,2,3) for txt/mat/tsf input file
%                       types
...
%   save_option    ...  switch (1 to 3) for no/eps/tiff print file
%   export_option  ...  switch (1 to 4) for no/txt/mat/tsf output file
...
if exist('time_gravity','var')
    ...
    switch export_option
        case 2
            ...
            fclose('all');
        case 3
            save(export_file,'out_mat','-mat7-binary');
        case 4
            fid = fopen(export_file,'w');
