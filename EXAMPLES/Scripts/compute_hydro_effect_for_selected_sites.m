...
DEM_file = 'f:\mikolaj\code\libraries\mGlobe_octave\EXAMPLES\Models\DEM_ETOPO2_example.mat'; % *.mat DEM (matlab array containing *.lon,*.lat,*.height layers), set to [] if not required. Use absolute path
